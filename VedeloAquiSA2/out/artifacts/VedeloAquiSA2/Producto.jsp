...
<div id="container">
    ...
    <form action="#" method="post" id="contact_form">
        ...
        <div class="name">
            ...
            <label for="descrProducto"> Descripción del producto  </label>
            <input id="descrProducto" name="descrProducto" type="text" required pattern="^{1,120}$"/>

        </div>

        <div class="name">

            <label for="descrEnganClienteProducto"> Descripción para enganchar cliente  </label>
            <input id="descrEnganClienteProducto" name="descrEnganClienteProducto" type="text" pattern="^{1,200}$" />
        ...
        <div class="submit">
            <input type="submit" value="Agregar" id="form_button" onclick="agregar()" />
        </div>
