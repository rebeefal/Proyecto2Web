...
<div id="contenerdor1">
    <div>
        <div class="square">
            ...
            <form action="<%=request.getContextPath()%>/ManejadorProveedores" method ="POST" >
                ...
                <input name="nombreProveedorInput" type="text"  pattern="^{1,120}$"  required />


                <lable id="contrasenaProveedorInputLable"> <h2>Contrasena</h2> </lable>
                <input name="contrasenaProveedorInput" type="password" pattern="(?=(.*[0-9]){2})(?=.*[a-z])(?=.*[A-Z]).{8,}" required/>

                <lable id="imagenProveedorLable" > <h2>Por favor ingrese el URL del logo </h2> </lable>
                <input name="logoProveedorInput" type="text" />
