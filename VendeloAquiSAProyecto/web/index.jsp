...
<div id="contenerdor1">
  <div>
    <div class="square">
      ...
      <form action="ingresaProveedor.jsp" method ="POST" >
        <input type="submit"  value="Ingresar Proveedor" />
      </form>

      <form action="conectaProductoProveedor.jsp" method ="POST" >
        <input type="submit"  value="Ingresar Producto"/>
      </form>

      <form action="<%=request.getContextPath()%>/ManejadorProveedores" method ="GET" >
