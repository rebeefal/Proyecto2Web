...
<div id="contenerdor1">
    <div>
        <div class="square">
            ...
            <form action="<%=request.getContextPath()%>/ManejadorProductos" method ="POST" >

                <h2> Ingrese un producto para el proveedor  <%= variable %>  </h2>

                </br>

                <input hidden=true" name="cedulaJurFisProveedorInput" required type="text" value="<%= variable %>"/>

                <input hidden="true" name="idProductoInput" type="text" required value="<%= variable %>"/>
